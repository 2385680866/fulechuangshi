                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="{{url('/author/update')}}/{{$info['author_id']}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b"><span class="input-group-addon">@</span>
                                        <input type="text" name="author_nickname" value="{{$info['author_nickname']}}" placeholder="作家笔名" class="form-control">
                                    </div>
                                </div>
                            </div> 
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b"><span class="input-group-addon">@</span>
                                        <input type="email" name="author_email" value="{{$info['author_email']}}" placeholder="作家邮箱" class="form-control">
                                    </div>
                                </div>
                            </div> 
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">作家头像</label>
                                <div class="col-sm-10">
                                    <div class="input-group m-b">
                                        <input type="file" name="author_img">
                                        <img src="{{$info['author_img']}}" alt="作家头像">
                                    </div>
                                </div>
                            </div> 
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b"><span class="input-group-addon">@</span>
                                        <input type="text" name="author_card" value="{{$info['author_card']}}" placeholder="作家身份证" class="form-control">
                                    </div>
                                </div>
                            </div> 
                            <div class="hr-line-dashed"></div>
    ...
    <script>
        ...
        $(document).on("blur","input[name='author_nickname']",function(){
            ...
            $.ajax({
                ...
                data:{author_nickname:author_nickname,author_id:author_id},
