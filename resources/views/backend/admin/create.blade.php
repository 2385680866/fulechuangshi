                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="{{url('/admin/store')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="tel" class="form-control" name="admin_tel" placeholder="请输入管理员手机号">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">管理员密码</label>
                                <div class="col-sm-10">
                                    <input type="password" class="form-control" name="admin_password" placeholder="请输入管理员密码">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="radio i-checks">
                                        <label><input type="radio" value="1" name="admin_status"> <i></i>会员</label>
                                    </div>
                                    <div class="radio i-checks">
                                        <label><input type="radio" value="0" name="admin_status"> <i></i>超级会员</label>
                                    </div>
                                </div>
                            </div>
