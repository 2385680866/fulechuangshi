            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="{{url('/link/store')}}">
                            @csrf
                            <div class="form-group">
                                <label class="col-sm-2 control-label">链接名称</label>
                                <div class="col-sm-10">
                                    <div class="input-group m-b"><span class="input-group-addon">@</span>
                                        <input type="text" name="link_name" placeholder="链接名称" class="form-control">
                                    </div>
                                </div>
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b"><span class="input-group-addon">@</span>
                                        <input type="text" name="link_url" placeholder="链接路由" class="form-control">
                                    </div>
                                </div>
                            </div> 
                            <div class="hr-line-dashed"></div>
