...
<head>
    ...
    <meta name="description" content="万古修仙群独家首发最新章节由chuangshi.qq.com创世中文网提供,并提供txt小说下载,创世中文网最新小说速度第一." />
    <meta name="keywords" content="万古修仙群最新章节_万古修仙群txt下载_万古修仙群无弹框_万古修仙群独家首发_创世中文网" />
    <meta property="qc:admins" content="151626767763051673016375" />
    <title>万古修仙群最新章节_万古修仙群txt下载_万古修仙群无弹框_万古修仙群独家首发_创世中文网</title>
...
<body>
    <link rel="stylesheet" type="text/css" href="/index/css/bookmain.css" /><!-- 3G站提示 -->
    ...
    <div class="wrap">
        ...
        <div class="mainbox">
            ...
            <div class="main1">
                <div class="title">
                    <i class="grey">
                        <img class="qqredaer_tit" src="/index/picture/qqread.png" title="万古修仙群" width="25" height="25" />
                    </i>
                    <a href="http://chuangshi.qq.com/bk/xx/27337639.html" title="万古修仙群官网">
                        <b>&nbsp;万古修仙群</b>
                    </a>
                    <i>连载中</i>
                    <span>|</span>
                ...
                <div class="tag">
                    <div class="y">
                        <a href="javascript:void(0)" title="万古修仙群">签约作品</a>
                    </div>
                    <div class="y">
                        <a href="javascript:void(0)" title="万古修仙群">付费作品</a>
                    </div>
                </div>
                ...
                <div class="tablist">
                    <ul>
                        <li class="this">
                            <a href="http://chuangshi.qq.com/bk/xx/27337639.html">介绍</a>
                        </li>
                        <li>
                            <a href="http://chuangshi.qq.com/bk/xx/AGoEM11jVjQAPVRiATIBbQ-l.html" class="active">目录</a>
                        </li>
                        <li class="midline">|</li>
                        <li>
                            <a target='_blank' href="http://account.book.qq.com/bk/author/ADZQOwdpWWJcPwttV2dTZQA4" class="active">作者</a>
                        </li>
                        <li class="midline">|</li>
                        <li>
                            <a href="http://chuangshi.qq.com/bk/xx/27337639-f.html" class="active">粉丝</a>
                        </li>
                        <li class="midline">|</li>
                    </ul>
                </div>
                ...
                <div class="left">
                    ...
                    <div class="cover">
                        ...
                        <a href="http://chuangshi.qq.com/bk/xx/AGoEM11jVjQAPVRiATIBbQ-l.html" class="bookcover">
                            <img src="{{$readFind['read_img']}}" width="204" height="255" alt="万古修仙群">
                        </a>
                    </div>
                    <div class="button1">
                    ...
                    <div class="title">
                        <a href="{{url('/')}}">首页</a>&gt;
                        <a href="http://chuangshi.qq.com/bk/xx/">{{$readcate['level0']}}</a>&gt;
                        <a href="http://chuangshi.qq.com/bk/xx/xx20016/">{{$readcate['level1']}}</a>&gt;
                        <strong>
                            <a href="http://chuangshi.qq.com/bk/xx/AGoEM11jVjQAPVRiATIBbQ-l.html">{{$readcate['level2']}}</a>
                        </strong>
                    ...
                    <div class="info">
                             {{$readFind['read_content']}}
                        <!-- <p>阴差阳错，莫名其妙的穿越成了一个朝不保夕的傀儡皇帝，杀机万千、步步惊魂！</p>
                        <p> 更不幸的是随身的万古修仙群开启，数不清的势力狼环虎视，渔父网图！</p>
                        <p> 如棋仙路，劫难纵横。</p>
                        <p> 矢志若卒，跬步帝心！</p>
                        <p> 极境争锋凌万道，豪气惊天冲九霄。</p>
                        <p> 履奇宫，闯罗殿，步灵墟、踏玄冢！</p>
                        <p> 天罗地网求出路，万象绝杀觅生机。</p>
                        <p> 热血少年，逆势而起，席卷万界，法执诸天！</p> -->
                    </div>
                    <div class="tags"> 作品标签：
                        狡猾、学生、穿越、阵法</div>
                    <!--植树节活动 奇迹树 弹框 start-->
                    <div class="arborDay" id="noveltreedetail" style="display:none;"></div><!-- 奇迹树 弹框 end -->
                </div>
                <div class="right">
                    <div class="autherinfo">
                        ...
                        <div class="au_name">
                            ...
                            <p>
                                <a href="http://account.book.qq.com/bk/author/ADZQOwdpWWJcPwttV2dTZQA4">玉剑云光</a>
                            </p>
                        </div>
