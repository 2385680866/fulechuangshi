            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal" action="{{url('/author/newdo')}}" enctype="multipart/form-data">
                            <input type="hidden" name="author_id" value={{$authorInfo['author_id']}}>
                            @csrf
                            <div class="form-group">
                                <label class="col-sm-2 control-label">新书名称</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="read_name" placeholder="新书名称">
                                </div>
                            </div>
                            <div class="form-group">
